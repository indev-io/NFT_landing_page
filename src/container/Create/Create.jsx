      ...
      <div className="app__create-left">
        <div className="app__create-left_main">
          <div className="left__main_1">
            <img className='create__nft' src={images.NFT_1} alt="NFT 1" />
            <img className='profil' src={images.avatar_4} alt="Profil Img" />
          </div>
          <div className="left__main_2">
            <img className='create__nft' src={images.NFT_2} alt="NFT 1" />
            <img className='profil' src={images.avatar_5} alt="Profil Img" />
          </div>
        </div>
        <div className="app__create-left_child">
            <img className='create__nft' src={images.NFT_3} alt="NFT 1" />
            <img className='profil' src={images.avatar_6} alt="Profil Img" />
        </div>
      </div>

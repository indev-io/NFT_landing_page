    ...
    <div className="app__top section__padding">
      <div className="app__top-left">
        <div className="app__top-left_main">
          <img className='left__main-img' src={images.NFT_1} alt="NFT 1" />
          <div className="main__information">
            <div className='profil'>
              <img src={images.avatar_1} alt="Profil" />
                <div>
                  <h2 className='h2__font1'>Wavy</h2>
        ...
        <div className="app__top-left_children_content">
          <div className="app__top-left_children">
            <img className='images__children' src={images.NFT_2} alt="NFT 2" />
            <div className="children__information">
              <h2 className='h2__font1'>Future Gradient CF#001</h2>
                <div className='bil'>
                  <img src={images.avatar_2} alt="Profil" />
                    <div>
          ...
          <div className="app__top-left_children">
            <img className='images__children' src={images.NFT_3} alt="NFT 2" />
            <div className="children__information">
              <h2 className='h2__font1'>Not Quite Dots FW#023</h2>
                <div className='bil'>
                  <img src={images.avatar_3} alt="Profil" />
                    <div>
                      <img src={images.eth3} alt="Etherum Icon" />
                      <span>0.25ETH</span>
                    </div>
          ...
          <div className="app__top-left_children">
            <img className='images__children' src={images.NFT_4} alt="NFT 2" />
            <div className="children__information">
              <h2 className='h2__font1'>Wavy Dimension PA#002</h2>
                <div className='bil'>
                  <img src={images.avatar_4} alt="Profil" />
                    <div>
                      <img src={images.eth3} alt="Etherum Icon" />
                      <span>0.25ETH</span>
                    </div>
